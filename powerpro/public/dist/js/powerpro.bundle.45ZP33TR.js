...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // sfc-script:/home/frappe/frappe-bench/apps/powerpro/powerpro/public/js/vue/cost_estimation/Material.vue?type=script
  ...
  // sfc-template:/home/frappe/frappe-bench/apps/powerpro/powerpro/public/js/vue/cost_estimation/Material.vue?type=template
  var _hoisted_1 = /* @__PURE__ */ createBaseVNode("h3", null, "Material Specification", -1);
  var _hoisted_2 = { class: "table table-bordered" };
  var _hoisted_3 = /* @__PURE__ */ createBaseVNode("th", null, "GSM", -1);
      ...
      createBaseVNode("table", _hoisted_2, [
        createBaseVNode("thead", null, [
          createBaseVNode("tr", null, [
            _hoisted_3,
            $props.raw_material_specs.base_material == "Paperboard" ? (openBlock(), createElementBlock("th", _hoisted_4, "Caliper")) : createCommentVNode("v-if", true),
            $props.raw_material_specs.base_material == "Paper" ? (openBlock(), createElementBlock("th", _hoisted_5, "Paper Weight")) : createCommentVNode("v-if", true),
            $props.raw_material_specs.material_format == "Roll" ? (openBlock(), createElementBlock("th", _hoisted_6, "Width")) : createCommentVNode("v-if", true),
            $props.raw_material_specs.material_format == "Sheet" ? (openBlock(), createElementBlock("th", _hoisted_7, "Dimension")) : createCommentVNode("v-if", true)
          ])
        ]),
        createBaseVNode("tbody", null, [
          createBaseVNode("tr", null, [
            createBaseVNode("td", null, toDisplayString($props.raw_material_specs.gsm), 1),
            $props.raw_material_specs.base_material == "Paperboard" ? (openBlock(), createElementBlock("td", _hoisted_8, toDisplayString($props.raw_material_specs.paperboard_caliper), 1)) : createCommentVNode("v-if", true),
            $props.raw_material_specs.base_material == "Paper" ? (openBlock(), createElementBlock("td", _hoisted_9, toDisplayString($props.raw_material_specs.paper_weight), 1)) : createCommentVNode("v-if", true),
            $props.raw_material_specs.material_format == "Roll" ? (openBlock(), createElementBlock("td", _hoisted_10, toDisplayString($props.raw_material_specs.roll_width) + " in", 1)) : createCommentVNode("v-if", true),
            $props.raw_material_specs.material_format == "Sheet" ? (openBlock(), createElementBlock("td", _hoisted_11, toDisplayString($props.raw_material_specs.sheet_width) + " x " + toDisplayString($props.raw_material_specs.sheet_height) + " in", 1)) : createCommentVNode("v-if", true)
          ])
        ])
      ])
    ]);
  ...
  // ../powerpro/powerpro/public/js/vue/cost_estimation/Material.vue
  Material_default.render = render;
  Material_default.__file = "../powerpro/powerpro/public/js/vue/cost_estimation/Material.vue";
  var Material_default2 = Material_default;
  ...
  // sfc-script:/home/frappe/frappe-bench/apps/powerpro/powerpro/public/js/vue/cost_estimation/CostEstimation.vue?type=script
  var CostEstimation_default = {
    ...
    components: {
      Material: Material_default2
    }
  };

  // sfc-template:/home/frappe/frappe-bench/apps/powerpro/powerpro/public/js/vue/cost_estimation/CostEstimation.vue?type=template
  var _hoisted_12 = { id: "cost-estimation" };
  var _hoisted_22 = /* @__PURE__ */ createBaseVNode("h5", null, "Material", -1);
  var _hoisted_32 = { class: "text-muted" };
  var _hoisted_42 = { class: "col col-sm-6" };
  var _hoisted_52 = { class: "form-group" };
  var _hoisted_62 = /* @__PURE__ */ createBaseVNode("label", { for: "quantity" }, "Quantity", -1);
  var _hoisted_72 = { class: "form-group" };
  var _hoisted_82 = /* @__PURE__ */ createBaseVNode("label", { for: "rate" }, "Rate", -1);
  var _hoisted_92 = { class: "form-group" };
  var _hoisted_102 = /* @__PURE__ */ createBaseVNode("label", { for: "amount" }, "Amount (USD)", -1);
  var _hoisted_112 = { class: "form-group text-right" };
  function render2(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_Material = resolveComponent("Material");
    return openBlock(), createElementBlock("div", _hoisted_12, [
      createBaseVNode("h4", null, toDisplayString($options.title), 1),
      _hoisted_22,
      createVNode(_component_Material, { raw_material_specs: $data.raw_material_specs }, null, 8, ["raw_material_specs"]),
      createBaseVNode("p", _hoisted_32, toDisplayString($data.doc.raw_material), 1),
      createBaseVNode("form", _hoisted_42, [
  ...
  CostEstimation_default.render = render2;
...
* @license MIT
**/
//# sourceMappingURL=powerpro.bundle.45ZP33TR.js.map
