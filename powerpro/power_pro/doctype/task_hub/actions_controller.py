...
def reopen_task(hub, task_id):
	...
	try:
		...
		return { "status": "success", "message": f"La tarea {task_id} ha sido reabierta." }
...
def complete_task(hub, task_id):
	...
	try:
		...
		return { "status": "success", "message": f"La tarea {task_id} ha sido completada." }
...
def change_status(hub, task_id, status):
	...
	try:
		...
		return { "status": "success", "message": f"La tarea {task_id} ha sido actualizada a {status!r}." }
...
def request_revision(hub, task_id):
	...
	try:
		...
		return { "status": "success", "message": f"La tarea {task_id} ha sido actualizada a 'Pending Review'." }
