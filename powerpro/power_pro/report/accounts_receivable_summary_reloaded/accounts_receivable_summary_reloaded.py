# Copyright (c) 2024, Miguel Higuera Contributors and contributors
...
class AccountsReceivableSummary(ReceivablePayableReport):
    ...
    def get_data(self, args):
        ...
        for party, party_dict in self.party_total.items():
            # Si hide_customers es True, ocultar clientes informales
            if hide_customers and frappe.get_cached_value("Customer", party, "informal_customer") == 1:
                continue  # Ignorar clientes informales si el valor de la configuración es True
