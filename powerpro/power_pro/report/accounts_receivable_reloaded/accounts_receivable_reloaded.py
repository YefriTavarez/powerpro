# Copyright (c) 2024, Miguel Higuera
...
class ReceivablePayableReport:
    def __init__(self, filters=None):
        ...
        self.igc_settings = get_igc_settings()
        self.hide_customers = self.igc_settings.hide_informal_customers

    def get_igc_settings(self):
    ...
    def run(self, args):
        ...
        if hide_customers:
            self.data = [row for row in self.data if not is_informal_customer(row.party)]
    ...
    def get_columns(self):
        ...
        # if not hide_customers:
        #     self.filters["customer"] = {
        #         "label": _("Customer"),
        #         "fieldname": "customer",
        #         "fieldtype": "Link",
        #         "options": "Customer",
    ...
    def get_chart_data(self):
        ...
        for row in self.data:
            ...
            if not cint(row.bold):
                if hide_customers and row.party_type == "Customer" and is_informal_customer(row.party):
                    continue
...
def is_informal_customer(party):
    doctype = "Customer"
