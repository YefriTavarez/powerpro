...
| Recargos coincidentes | Confirmados: extra35 + noche15 = recargo50; feriado100 + noche15 = recargo115. Base incluida una sola vez, con declaración explícita de cobertura salarial del feriado. | La coincidencia de feriado y descanso semanal dispone de selección explícita para efectivo: revisión, mayor recargo una vez o suma de ambos. La combinación de pago y descanso está disponible mediante opción independiente; las ventanas con obligaciones de descanso distintas requieren revisión. |
...
Feriado coincidente con descanso semanal: la política permite **Requiere revisión**, **Un solo recargo (el mayor)** o **Sumar ambos recargos** para efectivo. Con recargos de 100% y nocturnidad de 15%, una hora base de RD$100 produce RD$215 o RD$315 respectivamente; si la base está totalmente cubierta, RD$115 o RD$215 adicionales. La regla debe publicarse para la empresa y vigencia y requiere elección del empleado. La opción de pago del feriado junto con descanso compensatorio conserva el pago de feriado y nocturnidad y registra el crédito semanal con su duración continua. Estas opciones son tratamientos configurables, no una certificación de una fórmula legal única.
