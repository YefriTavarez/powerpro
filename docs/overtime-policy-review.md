...
Feriado coincidente con descanso semanal: la política permite **Requiere revisión**, **Un solo recargo (el mayor)** o **Sumar ambos recargos** para efectivo. Con recargos de 100% y nocturnidad de 15%, una hora base de RD$100 produce RD$215 o RD$315 respectivamente; si la base está totalmente cubierta, RD$115 o RD$215 adicionales. La regla debe publicarse para la empresa y vigencia y requiere elección del empleado. La combinación de pago del feriado con descanso compensatorio permanece pendiente. Estas opciones son tratamientos configurables, no una certificación de una fórmula legal única.
