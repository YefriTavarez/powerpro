...
El usuario sustituyó la muestra de julio por cuatro jornadas documentadas del 13 al 16 de agosto, confirmó los horarios y autorizó descargar los ponches por la API de Producción. La importación limitada a Desarrollo y su prueba del motor están en `overtime-imported-sample.md`. No volver a pedir que elija empleado/fechas. Las diferencias con los ponches, la evidencia semanal y la aceptación de liquidación siguen pendientes; la lectura adicional de semana/asistencias fue rechazada por revisión automática y requiere autorización expresa. Se conserva el límite de no activar scheduler global ni crear pagos automáticamente.
